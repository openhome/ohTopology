...
{
    public interface IServiceRadio
    {
    ...
    public interface IRadio : IServiceRadio
    {
        uint ChannelsMax { get; }
        string ProtocolInfo { get; }
    }

    public abstract class ServiceRadio : Service, IRadio
    {
        protected ServiceRadio(INetwork aNetwork, string aId)
        {
    ...
    {
        public ServiceRadioNetwork(INetwork aNetwork, string aId, CpDevice aDevice)
            : base(aNetwork, aId)
        {
            iNetwork = aNetwork;
    ...
    {
        public ServiceRadioMock(INetwork aNetwork, string aServiceId, uint aId, IList<uint> aIdArray, IInfoMetadata aMetadata, string aProtocolInfo, string aTransportState, uint aChannelsMax)
    ...
    public class ProxyRadio : IRadio, IProxy
    {
        public ProxyRadio(ServiceRadio aService, IWatchableDevice aDevice)
        {
            iService = aService;
            iDevice = aDevice;
        }
