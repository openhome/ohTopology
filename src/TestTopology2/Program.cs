    ...
    class Program
    {
        ...
        class GroupWatcher : IUnorderedWatcher<ITopology2Group>, IWatcher<string>, IWatcher<uint>, IWatcher<bool>, IDisposable
        {
            ...
            public void UnorderedAdd(ITopology2Group aItem)
            {
                ...
                iRunner.Result(string.Format("Group Added\t\t{0}:{1}", iStringLookup[string.Format("Room({0})(Proxy)", aItem.Id)], iStringLookup[string.Format("Name({0})(Proxy)", aItem.Id)]));
                iRunner.Result("===============================================");
            ...
            public void UnorderedRemove(ITopology2Group aItem)
            {
                ...
                iRunner.Result(string.Format("Group Removed\t\t{0}:{1}", iStringLookup[string.Format("Room({0})(Proxy)", aItem.Id)], iStringLookup[string.Format("Name({0})(Proxy)", aItem.Id)]));
                iStringLookup.Remove(string.Format("Room({0})(Proxy)", aItem.Id));
                iStringLookup.Remove(string.Format("Name({0})(Proxy)", aItem.Id));
            }
